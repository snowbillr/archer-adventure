export const adventurerPrefab = {
  ...
  tags: "sprite,physics-body,adventurer,attachment,hasHurtboxes,hasBounds,hasControls,hasInteractionCircle,sign-interactor,hasPhiniteStateMachine,shootsArrows",
