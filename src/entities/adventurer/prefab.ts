export const adventurerPrefab = {
  ...
  tags: "sprite,physics-body,adventurer,attachment,hasHurtboxes,bounds,hasControls,hasInteractionCircle,sign-interactor,hasPhiniteStateMachine,shootsArrows",
