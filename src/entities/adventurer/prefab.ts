export const adventurerPrefab = {
  ...
  tags: "sprite,physics-body,adventurer,hasAttachments,hasHurtboxes,hasBounds,hasControls,hasInteractionCircle,sign-interactor,hasPhiniteStateMachine,shootsArrows",
